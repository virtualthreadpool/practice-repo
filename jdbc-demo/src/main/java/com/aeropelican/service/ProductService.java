...
public class ProductService {
    ...
    public HashMap<Integer, Product> loadProducts() throws SQLException {
    ...
    public void buyProduct(int productId, int quantity)
        ...
        HashMap<Integer, Product> productMap = repository.getProductMap();
        ...
        boolean updated = repository.updateStock(productId, updatedStock);
